        ...
        <div className="divide-y">
          {filteredVehicles.length > 0 ? (
            filteredVehicles.map((vehicle) => (
              <div key={vehicle.id} className="grid grid-cols-6 gap-4 p-4 items-center">
                ...
                <div>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="text-red-600">Remove Vehicle</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
              </div>
            ...
            <div className="p-4 text-center text-slate-500">No vehicles found matching your search.</div>
          )}
        </div>
      </div>
    </div>
