...
function OperatorDashboard() {
  ...
  const [currentOperatorForTraining, setCurrentOperatorForTraining] =
    useState(null);
  ...
  const openTrainingModal = (operator) => {
    setCurrentOperatorForTraining(operator);
    setTrainingFormData({
      course_name: "",
      course_date: "",
      certification: "",
  ...
  const handleTrainingSave = async () => {
    try {
      const trainingData = {
        user: currentOperatorForTraining.id,
      ...
      await Api.createTrainingRecord(trainingData);
      setTrainingModalOpen(false);
      setCurrentOperatorForTraining(null);
      setTrainingFormData({
        course_name: "",
        course_date: "",
        certification: "",
      ...
      alert("Falha ao salvar registo de formação.");
    }
  };
        ...
        {operators.length > 0 ? (
          operators.map((operator) => (
            <Card key={operator.id}>
              ...
              <CardContent>
                <p>Base: {operator.username || "Sem base"}</p>
                <div className="space-y-2 mt-2">
                  ...
                  <Button
                    variant="outline"
                    onClick={() => openTrainingModal(operator)}
                  >
                    Adicionar Formação
                  </Button>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="none">Nenhuma base</SelectItem>
      ...
      {trainingModalOpen && (
        <Dialog open={trainingModalOpen} onOpenChange={setTrainingModalOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>
                Adicionar Formação para {currentOperatorForTraining?.username}
              </DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              <div>
